    ...
    export default {
      data() {
        return {
          ...
          scienceNewsLink: 'https://newsapi.org/v2/top-headlines?country=tr&category=science&apiKey=f1ddbf5d22b44e78bf658637e0713371',
          isBusy: false,
          showloader: false,
          totalResults: 0,
          articles: []
      ...
      methods: {
        ...
        fetchData(){
          ...
          let req = new Request(this.scienceNewsLink);
...
<template>
    <div class="mainHeadline">
        <h1>Top Science Headlines From Turkey</h1>
      </div>
